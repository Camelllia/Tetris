...
public class VolumeSlider : MonoBehaviour
{
    ...
    void Awake()
    {
        float savedVol = PlayerPrefs.GetFloat(Background, slider.maxValue);
    ...
    {
        //mixer.SetFloat(Background, ConvertToDecibel(_value / slider.maxValue)); //Dividing by max allows arbitrary positive slider maxValue
        PlayerPrefs.SetFloat(Background, _value);
    }
